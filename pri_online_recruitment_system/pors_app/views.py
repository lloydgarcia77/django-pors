...
def pri_applicant_test1_pre_employment(request, key, id):
    ...
    if request.is_ajax():
        if request.method == 'POST':
            ...
            defaults={'score_t1pe': score, 'over_t1pe' : over, 'status_t1pe': status, 'ratings_t1pe': ratings})
...
def pri_applicant_test2_simple_english(request, key, id):
    ...
    if request.is_ajax():
        if request.method == 'POST':
            ...
            defaults={'score_t2se': score, 'over_t2se' : over, 'status_t2se': status, 'ratings_t2se': ratings})
...
def pri_applicant_test3_essay(request, key, id):
    ...
    if request.method == 'POST':
        ...
        if essayForm.is_valid():
            ...
            defaults={'score_t3e': 0, 'over_t3e' : 30, 'status_t3e': 'On progress', 'ratings_t3e': 'On progress'})
...
def pri_applicant_test3_sct(request, key, id):
    ...
    if request.method == 'POST':
        ...
        if sctForm.is_valid():  
            ...
            defaults={'score_t3ptsct': 0, 'over_t3ptsct' : 15, 'status_t3ptsct': 'On progress', 'ratings_t3ptsct': 'On progress'})
...
def pri_applicant_test4_abstract_reasoning(request, key, id):
    ...
    if request.is_ajax():
        if request.method == 'POST': 
            ...
            defaults={'score_t4ar': score, 'over_t4ar' : over, 'status_t4ar': status, 'ratings_t4ar': ratings})
...
def pri_applicant_exam_ssct(request, key, id):
    ...
    if request.method == 'POST':
        ...
        if scctForm.is_valid():  
            ...
            defaults={'score_scct': 0, 'over_scct' : 60, 'status_scct': 'On progress', 'ratings_scct': 'On progress'})
...
def pri_applicant_exam_ccat(request, key, id):
    ...
    if request.method == 'POST':
        ...
        if ccatForm.is_valid():   
            ...
            defaults={'score_cca': 0, 'over_cca' : 60, 'status_cca': 'On progress', 'ratings_cca': 'On progress'})
...
def pri_applicant_exam_arp(request, key, id):
    ...
    if request.method == 'POST':
        ...
        if arpForm.is_valid():   
            ...
            defaults={'score_arp': 0, 'over_arp' : 65, 'status_arp': 'On progress', 'ratings_arp': 'On progress'})
